document.addEventListener('DOMContentLoaded', function () {
    ...
    // Get context with plain JavaScript - using document.getElementById()
    ...
    if (document.getElementById("linechart-multi")) {
        var multiLineCanvas = document.getElementById("linechart-multi").getContext("2d");
    ...
    if (document.getElementById("areachart-multi")) {
    ...
    if (document.getElementById("browserTrafficChart")) {
        var doughnutChartCanvas = document.getElementById("browserTrafficChart").getContext("2d");
        var doughnutChart = new Chart(doughnutChartCanvas, {
            type: 'doughnut',
